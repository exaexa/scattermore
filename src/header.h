...
void kernel_data_circle(const unsigned *dim, const float *radius, float *matrix, const float *data);
void kernel_data_gauss(const unsigned *dim, float *matrix, const float *data, const float *sigma);
